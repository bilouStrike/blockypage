...
module.exports = {
	...
	blpgeLibrary: resolvePlugin( 'src/blpge-library/index.js' ),
	blpgeCustomEditor: resolvePlugin( 'src/customJS/editor/index.js' ),
	blpgeCustomFront: resolvePlugin( 'src/customJS/front/index.js' ),
